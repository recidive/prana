...
Model.prototype.save = function(callback) {
  this.storage.save(this.type, this, function(error, item) {
...
Model.prototype.delete = function(callback) {
  this.storage.delete(this.type, this[this.type.settings.keyProperty], function(error, item) {
...
Model.compile = function(application, type) {
  ...
  MockModel.list = function(query, callback) {
    type.storage.list(type, query, function(error, items) {
      if (error) {
        return callback(error);
      }
      application.collect(type, items, function(error) {
